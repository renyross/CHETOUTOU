        ...
        <section class="premium-category-header">
            <div class="container">
                ...
                <div class="visual-carousel-wrapper">
                    ...
                    <!-- New button similar to the one in image 2 -->
                    <div class="carousel-footer-action">
                        <a href="panier-chien.html" class="btn-tout-afficher">Tout afficher</a>
                    </div>
                </div>
            </div>
        </section>
