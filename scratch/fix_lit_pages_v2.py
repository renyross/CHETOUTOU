...
# Visuals for Couchage
couchage_visuals = """
                            <a href="panier-chien.html" class="visual-card">
                                <div class="visual-card-img-box"><img src="cat_panier.png" alt="Paniers"></div>
                                <span class="visual-card-label">Paniers</span>
                            </a>
                            <a href="lit-chien.html" class="visual-card active">
                                <div class="visual-card-img-box"><img src="dog_bed_premium_1775489579429.png" alt="Lits"></div>
                                <span class="visual-card-label">Lits</span>
                            </a>
                            <a href="lit-xxl-chien.html" class="visual-card">
                                <div class="visual-card-img-box"><img src="cat_coussin_xxl_visual.png" alt="Lits XXL"></div>
                                <span class="visual-card-label">Lits XXL</span>
                            </a>
                            <a href="coussin-chien.html" class="visual-card">
                                <div class="visual-card-img-box"><img src="cat_coussin.png" alt="Coussins"></div>
                                <span class="visual-card-label">Coussins</span>
                            </a>
                            <a href="tapis-chien.html" class="visual-card">
                                <div class="visual-card-img-box"><img src="cat_tapis_xxl_visual.png" alt="Tapis"></div>
                                <span class="visual-card-label">Tapis</span>
                            </a>"""
...
standardize_page(
    ...
    lit_xxl_products,
    couchage_visuals.replace('active', '').replace('lit-xxl-chien.html" class="visual-card"', 'lit-xxl-chien.html" class="visual-card active"')
)
